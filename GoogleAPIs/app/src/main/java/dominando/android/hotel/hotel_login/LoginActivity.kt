package dominando.android.hotel.hotel_login
    ...
    private fun checkGooglePlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            ...
            if (api.isUserResolvableError(resultCode)) {
                val dialog = api.getErrorDialog(this, resultCode,
                ...
                Toast.makeText(this, R.string.error_play_services_not_supported, Toast.LENGTH_SHORT).show()
                finish()
            }
        }
    }
