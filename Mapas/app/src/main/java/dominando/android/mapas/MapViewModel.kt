...
class MapViewModel(app: Application) : AndroidViewModel(app), CoroutineScope {
    ...
    private val geofenceDb: GeofenceDb by lazy {
        GeofenceDb(getContext())
    }
        ...
        launch {
            currentLocationError.value = try {
                ...
                when (exception.statusCode) {
                    ...
                    LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> LocationError.GpsDisabled(exception as ResolvableApiException)
    ...
    data class GoogleApiConnectionStatus(val success: Boolean, val connectionResult: ConnectionResult? = null)
