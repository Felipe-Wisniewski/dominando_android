...
class HotelFormViewModelTests {
    ...
    private val anHotel = Hotel(id = anHotelID, name = "Ritz Recife", address = "Praia de Boa Viagem, SN",
        rating = 5.0f)
    ...
    @Test fun given_valid_hotel_info_should_save_a_hotel() {
        //Given
        val info = Hotel(name = "Ritz Recife", address = "Praia da Boa Viagem, Recife/PE", rating = 4.8f)
    ...
    @Test fun given_invalid_hotel_info_should_fail_at_save_the_hotel() {
        //Given
        val invalidInfo = Hotel(name = "Y", address = "WWW", rating = 4.8f)
