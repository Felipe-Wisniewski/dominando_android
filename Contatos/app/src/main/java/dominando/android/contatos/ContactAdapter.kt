...
class ContactAdapter(context: Context, c: Cursor?) : CursorAdapter(context, c, 0) {
    ...
    override fun newView(context: Context?, cursor: Cursor, parent: ViewGroup?): View {
        ...
        indexes = intArrayOf(cursor.getColumnIndex(ContactsContract.Contacts._ID),
    ...
    override fun bindView(view: View, context: Context, cursor: Cursor) {
        ...
        val contactUri = ContactsContract.Contacts.getLookupUri(cursor.getLong(indexes[0]), cursor.getString(indexes[1]))
