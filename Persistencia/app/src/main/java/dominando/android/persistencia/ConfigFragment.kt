...
class ConfigFragment : PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        editPrefCity = findPreference<EditTextPreference>(getString(R.string.pref_city)) as EditTextPreference

        listPrefSocialNetworks = findPreference<ListPreference>(getString(R.string.pref_social_network)) as ListPreference
