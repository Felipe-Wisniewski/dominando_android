...
class MainActivity : AppCompatActivity() {
    ...
    private fun selectMenuOption(menuItem: MenuItem) {
        ...
        //empilhando fragment
        val fragmet = FirstLevelFragment.newInstance(title)
        val transaction = supportFragmentManager
            .beginTransaction()
            .replace(R.id.content, fragmet, title)
            .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)

        if (content.childCount > 0) {  //nao adicionamos o primeiro fragment na backstack
