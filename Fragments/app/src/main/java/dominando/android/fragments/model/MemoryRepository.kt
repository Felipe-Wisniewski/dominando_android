...
object MemoryRepository : HotelRepository {
    ...
    init {
        ...
        save(Hotel(0, "Old Beach Hotel", "Av. Viagem Boa", 5F))
        save(Hotel(0, "New City Hotel", "Av. Daora Viagem", 4.1F))
        save(Hotel(0, "Old City Hotel", "Av. Irada Viagem", 4F))
        save(Hotel(0, "New Island Hotel", "Av. Top Viagem", 3.5F))
        save(Hotel(0, "Old Island Hotel", "Av. Viagem Animal", 3F))
        save(Hotel(0, "New Boat Hotel", "Av. Viagem", 1.5F))
        save(Hotel(0, "Old Boat Hotel", "Av. Ótima Viagem", 1.5F))
        save(Hotel(0, "New Bikini Hotel", "Av. Legal Viagem", 0.5F))
        save(Hotel(0, "Old Bikini Hotel", "Av. Bacana Viagem", 1F))
        save(Hotel(0, "New Hotel", "Av. Mal Viagem", 4.1F))
    }
